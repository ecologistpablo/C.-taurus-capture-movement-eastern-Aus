...
pdat$predicted_presence <- predict(m12$gam, newdata = pdat, type = "response")
...
p1 <- ggplot(pdat, aes(x = SST_anomaly, y = predicted_presence)) +
  ...
  labs(title = "Male departures at Coffs Harbour going north (n = 75)",
...
#save
ggsave(path = "Outputs/Graphs/Polishing/Models", "231221_CH_Departures_Nrth_Males.png",
