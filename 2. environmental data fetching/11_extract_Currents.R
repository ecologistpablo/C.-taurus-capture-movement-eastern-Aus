...
cstack <- rast("IMOS/Current_stack_2012-2025.tif") #currents stack
rcs <- read_rds("Inputs/260323_step9_coordinates.rds") #xy points
...
write_rds(cur.pts4, file = "Inputs/260329_Currents_vals_12-25.rds")
