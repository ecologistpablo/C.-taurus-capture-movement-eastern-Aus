...
sst.pts <- extract(rstack, pts.UTM, ID = F) 
...
hist(sst.pts[, 1], col="grey", main="Max temp (°C)") 

sum(is.na(sst.pts))
3871 * 127 #how many obs in total
491617 - 349402 #total obs - NAs
#total obs = 142,215 out of 491,167
#appox. 75% is NA
...
sum(is.na(sst.pts)) - sum(is.na(sst.pts1)) 
#we filled 132,590 points

sum(is.na(sst.pts1))
491617 - 216812
#still have approx. 50% of NAs in the df
...
sum(is.na(sst.pts1)) - sum(is.na(sst.pts2)) 
#only 22 were filled :o

sum(is.na(sst.pts2)) 
#still 216,790 out of 491,000 that are NA
...
#manually inspect, will travelling in time help a lot?
