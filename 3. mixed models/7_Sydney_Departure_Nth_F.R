...
summary(m12$gam) #love to see it - we have a winner
...
SST1 <- SST + 
  ...
  labs(x = "Sea surface temperature (°C) temporal anomaly",
       ...
       title = "Female departures going north at Sydney (n = 66)") +
  scale_y_continuous(
...
#save
ggsave(path = "outputs/Graphs/Final/Models", "240814_Sydney_Departure_Nth_F.pdf",
