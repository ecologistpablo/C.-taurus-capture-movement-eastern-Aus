...
#ay caramba, m1 has non-linearity in GSLA
...
SST1 <- SST + 
  ...
  labs(x = "Temporal anomaly of Sea Surface Temperature (°C)",
       ...
       title = "Male arrivals from south at Moreton - North Stradbroke Islands (n = 201)") +
  scale_y_continuous(
...
#save
ggsave(path = "Outputs/Graphs/Final/Models", "240912_MI-NSI_Male_Arrival_Nrth_extended.pdf",
